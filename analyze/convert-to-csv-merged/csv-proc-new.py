...
def convert_proc_new_to_csv(input_file_path, output_file_path):
    """
    Reads JSON new process data and writes it to a CSV file.
    ...
    print(f"Successfully converted new process data to '{output_file_path}'")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Parse new process data (json-like) and convert it to a CSV file.",
    ...
    convert_proc_new_to_csv(args.input_file, args.output)
