...
Example: client.a.b.c.d -> ./a_b_c_d/client-data/proc-cpu.csv
...
int main(int argc, char* argv[]) {
    ...
    while (std::getline(infile, line)) {
        ...
        try {
            ...
            fs::path output_file = output_dir / "proc-cpu.csv";
            std::string output_path_str = output_file.string();

            // --- 2. Buffer Data ---
            // ADDED VmRss extraction here
